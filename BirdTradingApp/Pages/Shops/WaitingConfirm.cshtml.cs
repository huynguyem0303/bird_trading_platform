...
namespace BirdTradingApp.Pages.Shops
{
    public class WaitingConfirmModel : PageModel
    {
        ...
        public async Task OnGetAsync(string searchString, string searchBy)
        {
            ...
            //    {
            //        ShippingSession = _unitOfWork.ShippingSessionRepository.GetByOrderIdAndStatusAsync(item.OrderId, OrderStatus.WaitingForConfirm).Result;
            //        continue;
            //    }
            //    if (ShippingSession != null)
            //    {
            //        ShippingSession.AddRange(_unitOfWork.ShippingSessionRepository.GetByOrderIdAndStatusAsync(item.OrderId, OrderStatus.WaitingForConfirm).Result);
            //        continue;
            //    }
