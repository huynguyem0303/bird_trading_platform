...
namespace BirdTradingApp.Pages.Shops
{
    public class OnDeliveringModel : PageModel
    {
        ...
        public async Task OnGetAsync(string searchString, string searchBy)
        {
            ...
            //    {
            //        ShippingSession = _unitOfWork.ShippingSessionRepository.GetByOrderIdAndStatusAsync(item.OrderId, OrderStatus.OnDelelivering).Result;
            //        continue;
            //    }
            //    if (ShippingSession != null)
            //    {
            //        ShippingSession.AddRange(_unitOfWork.ShippingSessionRepository.GetByOrderIdAndStatusAsync(item.OrderId, OrderStatus.OnDelelivering).Result);
            //        continue;
            //    }
