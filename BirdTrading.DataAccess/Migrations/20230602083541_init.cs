...
namespace BirdTrading.DataAccess.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ShippingInformationUser",
                columns: table => new
                {
                    ShippingInformationsId = table.Column<int>(type: "int", nullable: false),
                    UsersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingInformationUser", x => new { x.ShippingInformationsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_ShippingInformationUser_ShippingInformation_ShippingInformationsId",
                        column: x => x.ShippingInformationsId,
                        principalTable: "ShippingInformation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShippingInformationUser_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingSessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShippingSessions_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingInformationUser_UsersId",
                table: "ShippingInformationUser",
                column: "UsersId");

            migrationBuilder.CreateIndex(
                name: "IX_ShippingSessions_OrderId",
